...
public class Admin_Local_Flight extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Admin_Local_Flight frame = new Admin_Local_Flight();
	...
	public Admin_Local_Flight() {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Admin_Add_Entries obj=new Admin_Add_Entries();
				obj.setVisible(true);
				dispose();
		...
		lblNewLabel = new JLabel("Admin Local Flight");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel.setForeground(new Color(255, 0, 0));
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setBounds(218, 11, 153, 23);
