...
public class Passenger_International_Flight extends JFrame {

	private JPanel contentPane;
	//Array List of International flights is created 
	static ArrayList<International_Flights>list=new ArrayList<International_Flights>();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Passenger_International_Flight frame = new Passenger_International_Flight();
	 ...
	 * Create the frame.
	 */
	public Passenger_International_Flight() {
		...
		for(International_Flights object: Admin_Int_Flight.Ilist)
		{
		...
		lblNewLabel = new JLabel("Passenger International Flight");
		lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD, 14));
		lblNewLabel.setForeground(new Color(204, 0, 0));
		lblNewLabel.setBounds(214, 11, 215, 23);
